...
```
## here() starts at D:/TA files/Winter2021 BIS15L/students_rep/BIS15W2021_mfrey
```
...
```
## # A tibble: 5 x 4
##   country         year_1920 year_2020 life_change
##   <fct>               <dbl>     <dbl>       <dbl>
...
```
## # A tibble: 5 x 4
##   country       year_1920  year_2020 pop_growth
##   <fct>             <dbl>      <dbl>      <dbl>
...
```
## # A tibble: 5 x 4
##   country    year_1920 year_2020 gdp_growth
##   <fct>          <dbl>     <dbl>      <dbl>
...
```
## # A tibble: 18,887 x 5
##    country     year  life_exp pop_size income
##    <fct>       <chr>    <dbl>    <dbl>  <dbl>
