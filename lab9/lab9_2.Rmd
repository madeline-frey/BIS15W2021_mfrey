...
#this just serves to double-check boxplot accuracy. 
```
...
homerange %>% 
  ...
  geom_boxplot()
#to make a boxplot, don't need to pre-calculate min,max, and median. 
#black dots represent outliers. Beyond quartiles. 
```
